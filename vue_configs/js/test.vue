<template>
    ...
    <div class="content-wrapper">
      <div class="image-selection-area">
        ...
        <div class="screenshot-area">
          <van-image
            :src="screenshotImg" id="screenshotView" fit="contain"
                        @click="choicescreenshot"
  ...
  <van-field v-model="featuresImgRoute.path" label="小图路径" class="custom-field" placeholder="自定义小图路径(可选)" input-align="right">
        <template #right-icon>
        ...
        <van-cell center title="大图识别区域:area">
          <template #right-icon>
            <van-popover v-model:show="showPopoverArea" theme="dark" :actions="area_actions" @select="onSelectArea" placement="bottom-end" overlay>
              <template #reference>
                <div>
                  {{ areaSelectDisplay }}
        ...
        <van-cell center title="特征匹配方式:matcher" class="custom-cell">
          <template #right-icon>
            <van-popover v-model:show="showPopoverMatcher" theme="dark" :actions="matcherActions" @select="onSelectMatcher" placement="bottom-end" overlay>
              <template #reference>
                <div>
        ...
        <van-cell title="矩形误差值:rectangular_error">
          <van-stepper
            ...
            integer
            button-size="25px"
            @change="onStepperChange('rectangular_error', $event)"
          ></van-stepper> 
        </van-cell>
      ...
      <van-cell
        :title="visualizationResultTitle"
        is-link
        @click="toggleVisualizationResult"
      >
        <template #right-icon>
      ...
      <van-collapse v-if="showImagesResult" v-model="activeNames">
        ...
        <van-collapse-item 
          v-for="(path, index) in currentTemplateInfo.visualization" 
          :key="index" v-show="path !== ''"
