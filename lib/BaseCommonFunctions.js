...
let Timers = require('./prototype/Timers.js')

let formatDate = require('./DateUtil.js')
let FileUtils = require('./prototype/FileUtils.js')
let _logUtils = require('./prototype/LogUtils.js')
let storageFactory = require('./prototype/StorageFactory.js')
...
function CommonFunctions () {
  ...
  //  Settings.Secure.putString(context.getContentResolver(), Settings.Secure.ACCESSIBILITY_ENABLED, '0')
    _logUtils.warnInfo('无障碍服务异常，定时任务启动失败')
   // this.setUpAutoStart(0.1)
    exit()
  }
