...
timed_tasks_set = function (timed_tasks_list, callback) {
                        ...
                        <vertical>
                            ...
                            <card id="car" w="*" h="auto" margin="5 0 5 0" cardCornerRadius="2dp"
                                ...
                                <radiogroup mariginTop="0" w="*">
                                    ...
                                    <radiogroup id="execution" orientation="vertical" >

                                        <radio id="execution_x" text="上一次作战" checked="true" />
                                        <radio id="execution_z" text="自定义模式" marginLeft="110" marginTop="-32" />
                                        <radio id="execution_j" text="龙门外环" />
                                        <radio id="execution_l" text="基建收菜" marginLeft="110" marginTop="-32" />
                                    ...
                                    <vertical id="li2" padding="0 0 0 0" w="*" layout_gravity="center" visibility="gone">
                                        ...
                                        <horizontal margin="0 0 0 0" weightSum='4' gravity="center_horizontal">
                                            ...
                                            <checkbox id='z7' text="周日" h='*' w='0dp' layout_weight='1'>
                                            </checkbox>
                                        </horizontal>
        ...
        uii.z6.on("check", (checked) => {
            if (checked) {
                ...
                removeByVal(arr, '六', "删除");
            }
        });
        uii.z7.on("check", (checked) => {
            if (checked) {
                arr.splice(6, 0, '日');
            } else {
                removeByVal(arr, '日', "删除");
            }
        });
        ...
        function snakebar(text, sleep) {
            sleep = sleep || 1000;
            com.google.android.material.snackbar.Snackbar.make(uii.wenn, text, sleep).show();
        }
